...
Several approaches exist, most of which rely including smart holds (\todo{reference}) or visual detection (\todo{reference}).
However, smart holds are rather expensive and visual detection suffers from reliability issues (\todo{reference}).
